...
class ObjectRenderer:
    ...
    def load_wall_textures(self):
        return{
            ...
            12: self.get_texture('resources/textures/textures/cyan (1).png'),
            13: self.get_texture('resources/textures/textures/cyan (2).png'),
            14: self.get_texture('resources/textures/textures/cyan (3).png'),
            15: self.get_texture('resources/textures/textures/cyan (4).png'),
